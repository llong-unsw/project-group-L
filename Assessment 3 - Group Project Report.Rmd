...
```{r aemo_final_plot, out.height = "40%", out.width = "100%"}
plot_predictions(
...
```{r lasso_final_plot, out.height = "40%", out.width = "100%"}
plot_predictions(
  actual = actual_holdout_demand
  , pred = lasso_pred
  , model = "lasso"
...
```{r svr_final_plot, out.height = "40%", out.width = "100%"}
plot_predictions(
  actual = actual_holdout_demand
  , pred = svr_pred
  , model = "SVR"
...
```{r rf_final_plot, out.height = "40%", out.width = "100%"}
plot_predictions(
  actual = actual_holdout_demand
  , pred = rf_pred
  , model = "random forest"
